          ...
          content: {
            ...
            text: campaign_id
              ...
              : [
                  ...
                  'Call load_campaign with no campaign_id, show me the campaigns as a short numbered list (name, story shape, last recap snippet, character),',
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                'that fit that setting, show them to me, and save them with mark_story_filled, remember {op: fact}, update_objectives,',
                'time {op: set_calendar} and checkpoint {op: save}.',
                ...
                'Then write the outline before we play: call story {op: outline} with the premise, the ending you are steering towards',
                'and your DM-only notes (the twist - I do not see those), story {op: act} for two or three acts with their goals,',
                'story {op: open_chapter} for the first chapter, and time {op: set_calendar} with the starting date and era I gave you (or one you picked).',
